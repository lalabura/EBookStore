					...
					<tr class='objhide' over="no">
                      ...
                      <s:iterator value="ciBuy" var="ci">
						<tr class='td_no_bord'>
							...
							<td>
							<a href="http://localhost:8080/EBookStore/main/book_view?id=${ci.pro.id }">${ci.pro.product_name }</a>
							</td>
							<td>
								<a href="http://localhost:8080/EBookStore/main/book_view?id=${ci.pro.id }"><IMG id=img_show_prd
